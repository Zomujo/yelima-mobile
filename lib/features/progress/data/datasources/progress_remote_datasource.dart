...
abstract class ProgressRemoteDataSource {
  ...
  Future<VitalTrend> getVitalTrend(
...
class ProgressRemoteDataSourceImpl implements ProgressRemoteDataSource {
  ...
  Future<BPTrend> getBPTrend({required String dateRange}) async {
    final response = await _apiClient
        .get('/api/v1/client/vital-histories/trends/bp', queryParameters: {
      'dateRange': dateRange,
    });
  ...
  @override
  Future<VitalTrend> getVitalTrend(
      {required String vitalType, required String dateRange}) async {
    final response = await _apiClient
        .get('/api/v1/client/vital-histories/trends', queryParameters: {
      'vitalType': vitalType,
      'dateRange': dateRange,
    });
